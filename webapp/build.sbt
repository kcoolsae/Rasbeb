...
TwirlKeys.templateImports ++= Seq("bindings._", "snippets._", "be.bebras.rasbeb.db.data._", "be.bebras.rasbeb.db.dao._")

PlayKeys.routesImport ++= Seq("bindings._", "bindings.Binders._", "be.bebras.rasbeb.db.data._")
